document.addEventListener("DOMContentLoaded", () => {
  ...
  const cardArray = [
    ...
    {
      name: "9",
      img: "Komm mit mir Karten spielen.",
    },
    {
      name: "10",
    ...
    {
      name: "10",
      img: "Ich spiele lieber Basketball.",
    },
    {
      name: "11",
  ...
  function checkForMatch() {
    ...
    if (cardsWon.length === cardArray.length / 2) {
      resultDisplay.innerHTML =
        " <h1>Congratulations! You found them all!</h1><h2>Level 8 completed!</h2><a href='https://elaidina.github.io/deu1/level9.html'> Continue to Level 9</a>";
