document.addEventListener("DOMContentLoaded", () => {
  ...
  const cardArray = [
    ...
    {
      name: "2",
      img: "Kannst du die Türe schließen?",
    },
    {
      name: "3",
    ...
    {
      name: "6",
      img: "Du musst dein Frühstück essen.",
    },
    {
      name: "7",
  ...
  function checkForMatch() {
    ...
    if (cardsWon.length === cardArray.length / 2) {
      resultDisplay.innerHTML =
        " <h1>Congratulations! You found them all!</h1><h2>Level 5 completed!</h2><a href='https://elaidina.github.io/deu1/level6.html'> Continue to Level 6</a>";
