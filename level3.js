document.addEventListener("DOMContentLoaded", () => {
  ...
  const cardArray = [
    ...
    {
      name: "10",
      img: "This apple is red.",
    },
    {
      name: "10",
      img: "Dieser Apfel ist rot.",
    },
    {
      name: "11",
    ...
    {
      name: "12",
      img: "Rosa ist meine Lieblingsfarbe.",
    },
  ];
  ...
  function checkForMatch() {
    ...
    if (cardsWon.length === cardArray.length / 2) {
      resultDisplay.innerHTML =
        ' <h1>Congratulations! You found them all!</h1><h2>Level 3 completed!</h2><a href="https://elaidina.github.io/deu1/level4.html"> Continue to Level 4</a>';
